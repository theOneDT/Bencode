<?php
  ...
  use TheOneDT\Bencode\ParseErrorException;
  ...
  class DecodeTest extends TestCase {
    ...
    public function testDecodeTorrent()
    {
      ...
      $torrent = ['announce' => 'http://torrent.foobar.baz:9374/announce', 'announce-list' => [['http://torrent.foobar.baz:9374/announce'], ['http://ipv6.torrent.foobar.baz:9374/announce'],], 'comment' => 'My torrent comment goes here :)', 'creation date' => 1382003607, 'info' => ['length' => 925892608, 'name' => 'some-file.boo', 'piece length' => 524288, 'pieces' => '',],];
